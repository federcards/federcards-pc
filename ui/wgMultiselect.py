...
"""
https://github.com/npcole/npyscreen/blob/master/npyscreen/wgmultiselect.py

A desultory f**king mistake that caused so much trouble and yet as of 2019
still not updated via pip.
"""


from npyscreen import wgmultiline    as multiline
from npyscreen import wgselectone    as selectone
